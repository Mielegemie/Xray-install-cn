...
get_latest_version() {
  ...
  for i in "${!releases_list[@]}"; do
    ...
    url_zip="https://edgeone.gh-proxy.org/https://github.com/XTLS/Xray-core/releases/download/${releases_list[$i]}/Xray-linux-$MACHINE.zip"
...
download_xray() {
  local DOWNLOAD_LINK="https://edgeone.gh-proxy.org/https://github.com/XTLS/Xray-core/releases/download/${INSTALL_VERSION}/Xray-linux-${MACHINE}.zip"
